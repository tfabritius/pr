...
ALTER TABLE "portfolios_transactions" ADD FOREIGN KEY ("portfolio_id", "partner_transaction_uuid") REFERENCES "portfolios_transactions"("portfolio_id", "uuid") ON DELETE SET NULL ON UPDATE CASCADE;
